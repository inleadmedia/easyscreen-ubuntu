...
```
wget -qO- https://raw.githubusercontent.com/inleadmedia/easyscreen-ubuntu/new-installation/oem-install.sh | sudo bash
```
...
```
wget -qO- https://raw.githubusercontent.com/inleadmedia/easyscreen-ubuntu/new-installation/oobp-install.sh | sudo bash
```
